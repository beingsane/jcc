...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_BOOKS_BATCH_OPTIONS');?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_BOOKS_BATCH_TIP'); ?></p>
		...
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('batch.item', 'com_books');?>
			</div>
		</div>
		<?php endif; ?>
	</div>
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('details.batch');">
