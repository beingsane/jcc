...
/**
 * Item Model for details.
 *
 * @package     Books
 * @subpackage  Models
 */
class BooksModelDetails extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_BOOKS';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_books.details';
	 ...
	 */
	public function getTable($type = 'Details', $prefix = 'BooksTable', $config = array())
	{
